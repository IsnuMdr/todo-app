...
const Toast = ({
  ...
  useEffect(() => {
    // Trigger entrance animation after effect completes
      ...
      >
        <div className="p-4">
          <div className="flex items-start gap-3">
            ...
            <div className="flex-1 min-w-0">
              {title && (
                <h3
                  className={`text-sm font-semibold mb-0.5 ${variants[variant].title}`}
                >
                  {title}
                </h3>
              )}
              <p className={`text-sm ${variants[variant].text}`}>{message}</p>
            </div>
        ...
        {duration > 0 && (
          <div className="h-1 bg-gray-100">
            <div
              className={`h-full ${variants[variant].progress} transition-all ease-linear`}
              style={{
